...
export default function ContactPage() {
  ...
  return (
    <section className="about-section">
      ...
      <FloatingCircle className="circle-3-blue" diameter={150} position={{ top: 20, left: 300 }} />
...
function Photo({ url, name, position, rotate = "0deg" }) {
  return (
    <div className="photo-img" style={{ ...position, transform: `rotate(${rotate})` }}>
